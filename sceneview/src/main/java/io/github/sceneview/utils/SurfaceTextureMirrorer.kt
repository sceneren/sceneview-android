...
import io.github.sceneview.SceneTextureView

/**
 * Displays the Camera stream using Filament.
 */
class SurfaceTextureMirrorer {
    ...
    fun onFrame(sceneView: SceneTextureView) {
     ...
     */
    fun stopMirroring(sceneView: SceneTextureView, surface: Surface) {
